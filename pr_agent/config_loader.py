...
global_settings = Dynaconf(
    ...
    settings_files=[join(current_dir, f) for f in [
        ...
        "settings/pr_reviewer_prompts_pt-br.toml",
        "settings/pr_questions_prompts.toml",
        "settings/pr_line_questions_prompts.toml",
        "settings/pr_description_prompts.toml",
        "settings/pr_description_prompts_pt-br.toml",
        ...
        "settings/pr_update_changelog_prompts_pt-br.toml",
        "settings/pr_custom_labels.toml",
        "settings/pr_add_docs.toml",
        "settings/custom_labels.toml",
        "settings/pr_help_prompts.toml",
        "settings/pr_help_prompts_pt-br.toml",
        "settings/pr_help_docs_prompts.toml",
        "settings/pr_help_docs_prompts_pt-br.toml",
